	...
	return (
		...
		>
			<div className='px-6 mx-auto max-w-screen-xl text-center py-24 lg:py-56'>
				...
				<h2 className='mb-10 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48'>
				...
				<div className='flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 '>
					<a
						href='giving'
						className='inline-flex justify-center items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-sky-600 focus:ring-4 focus:ring-gray-400 hover:scale-110 duration-300 bg-blue-gray-600'
					>
						Donate
					</a>
